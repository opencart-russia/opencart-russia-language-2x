...
$_['entry_icon_sort_order']			= 'Иконка порядок сортировки';
...
$_['entry_display_checkout']		= 'Показать иконку быстрого заказа';
$_['entry_allow_notes']				= 'Разрешить заметки';
$_['entry_logo']					= 'Логотип';
$_['entry_border_colour']			= 'Цвет рамки шапки';
$_['entry_header_colour']			= 'Цвет фона шапки';
$_['entry_page_colour']				= 'Цвет фона страницы';

// Tab
$_['tab_general']					= 'Основное';
$_['tab_api_details']				= 'API детали';
$_['tab_order_status']				= 'Статус заказа';
$_['tab_customise']					= 'Настройка оформления';
